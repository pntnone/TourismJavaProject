 ...
 */
package com.pnttour.travelproject.controller.filter;
...
import com.pnttour.travelproject.utils.SecurityUtil;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(SecurityUtil.isSecurityPage(req)){
            ...
            if(user == null){
                String uriPath = req.getServletPath();
                if(req.getQueryString()!=null){
                    uriPath+="?" + req.getQueryString();
                }                
                req.setAttribute("UriAfterLogin",uriPath);
                System.out.println(uriPath);
                req.getRequestDispatcher("./login").forward(req, res);
                return;
            }
            RoleDAO rd = new RoleDAOImp();
            String roleCode = rd.findOne(user.getRoleId()).getCode();
            
            if(roleCode.equals("ad")){
                chain.doFilter(req, res);
                return;
            }
            
            if(!SecurityUtil.hasPermission(req,roleCode)){
