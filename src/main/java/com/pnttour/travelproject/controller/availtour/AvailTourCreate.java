 ...
 * @author Admin
 */
@WebServlet(name = "AvailTourCreate", urlPatterns = {"/avail-tour-create","/AvailTourCreate"})
public class AvailTourCreate extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./availtour/createAvail.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Long id = tourService.createAvailTour(av);
        if(id == null){
