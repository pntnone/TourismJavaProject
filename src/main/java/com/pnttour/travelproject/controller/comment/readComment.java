 ...
 */
package com.pnttour.travelproject.controller.comment;
...
public class readComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Comment> comments = cmService.findAllCommentsByAccountId(Long.valueOf(accountId));
        request.setAttribute("Comments", comments);
        request.getRequestDispatcher("./admin_comment/commentHistory.jsp").forward(request, response);
