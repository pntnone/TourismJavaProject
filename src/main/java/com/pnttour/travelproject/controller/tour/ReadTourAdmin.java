 ...
 * @author Admin
 */
@WebServlet(name = "ReadTourAdmin", urlPatterns = {"/admin-tours","/ReadTourAdmin"})
public class ReadTourAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Populate 2 table on id
        PageFormInfor page = FormUtil.toModel(PageFormInfor.class, request);
        page.setMaxItemsInPage(10);
        List<TourFrontEnd> tours = tourService.getAllTourInfo(page);
        if(tours==null){
        ...
        request.getRequestDispatcher("./tour/toursShow.jsp").forward(request, response);
    }
