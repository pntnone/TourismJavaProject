 ...
 * @author Admin
 */
@WebServlet(name = "CreateTourAdmin", urlPatterns = {"/admin-tour-create","/CreateTourAdmin"})
public class CreateTourAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./tour/createTour.jsp").forward(request, response);
    }
