...
<div class="about" style="padding-left: 50px;
    ...
    <form class="text-center border border-light p-5" id="formsub" method="post" action="<c:url value="/avail-tour-create"/>">

        <p class="h4 mb-4">TẠO CHI NHÁNH MỚI</p>

        <div class="form-row mb-4">
            <div class="col">
                <input type="text"  name="departure" class="form-control" placeholder="BẮT ĐẦU">
            </div>
            <div class="col">
                <input type="text" name="destination" class="form-control" placeholder="ĐẾN">
            </div>
        </div>


        <input type="text" name="thumbnail" id="imgName" class="form-control mb-4" placeholder="TÊN ẢNH">
        <h5>Ảnh Minh Họa</h5>
        <div id="imaPlace"></div>

        <br>

        <input type="number" name="categoryTourId" id="cateId" class="form-control" placeholder="THỂ LOẠI MIỀN ID">
